			...
			<div class = "Memform-container">
				...
				<form class = "row g-3" action="MemberRegister" method="post">
					...
					<div class = "col-md-6">
  					...
  					<div class = "col-md-6">
						<fieldset class="mb-3">
    					<legend class="col-form-label pt-0">Preferred Delivery Time</legend>
      						<div class="form-check form-check-inline">
        						<input class="form-check-input" type="radio" name="deltime" id="none" value="NONE" checked>
        						<label class="form-check-label" for="none">
          							None
        						</label>
      						</div>
      						<div class="form-check form-check-inline">
        						<input class="form-check-input" type="radio" name="deltime" id="morning" value="MORNING">
        						<label class="form-check-label" for="morning">
          							Morning
        						</label>
      						</div>
      						<div class="form-check form-check-inline">
        						<input class="form-check-input" type="radio" name="deltime" id="afternoon" value="AFTERNOON">
        						<label class="form-check-label" for="afternoon">
          							Afternoon
        						</label>
      						</div>
      						<div class="form-check form-check-inline">
        						<input class="form-check-input" type="radio" name="deltime" id="evening" value="EVENING">
